...
Delta IA/flujo de PR #7 aplica gates existentes: B02 acceso/disclosure/shadow, B03 deduplicación/mandatos, B07 determinismo contable, B08 snapshots/comparación, B09 accesibilidad, B12 efectos, B13 recuperación y B15 rendimiento; B16/D01 activación IA. C01/C10/C11/C13 y los gates de cada hecho siguen abiertos. No nuevo gate ni cierre profesional: **A0 / B16 / C13 / D6**. [Review](../review.md) posee el estado de revisión final, no este registro.
...
| B16 AI/Security — antes de función activada por D01 | Asistencia/experimento mejora evaluación sin autoridad oficial ni acceso indebido | Corpus sintético, inyección, comparación con resultado revisado, calidad/coste/latencia, provenance y aislamiento shadow | Cero escritura/confirmación autónoma oficial/fuga; shadow solo ledger experimental; umbral de utilidad fijado antes y cumplido | Desactivar función y conservar flujo manual/determinístico; ningún puerto oficial para modelo/shadow |
...
| C08 Tax + contador / DH4 | RER/IGV/SIRE/RVIE/RCE/SPOT/retenciones/percepciones/no domiciliados, cohortes/cronograma/valores reales | Perfiles/reglas con vigencia, determinación y registros, puente libro→fiscal→declarado→pagado y [mirror/casillas/eficacia](../specs/flows/external-tax-filing-mirror.md) por revisión | Determinar/aprobar/presentar/pagar obligación real sin perfil/fuente/hechos; ND se resuelve antes de contratar/pagar servicio |
...
|---|---|---|
| D01 AI/Architecture | Activación de Accounting IA/shadow confirmados en diseño M07–M08; DeepSeek V4.1-Flash inicial elegido, recursos locales/otros pilotos opcionales | [Contrato](../accounting/templates-automation-shadow.md) requerido en diseño; antes de activar: propósito/mandato, minimización/DPA, versiones, corpus/umbral B16, [presupuesto/horarios/contrato DeepSeek](../architecture/ai-assistance.md#presupuesto-y-programación-del-proveedor-inicial) y aislamiento B02/B13/B15. Otros pilotos mantienen trigger de beneficio esperado/autorización. Flujo manual/determinístico completo permanece válido; D01 no vuelve opcional construir el diseño confirmado |
