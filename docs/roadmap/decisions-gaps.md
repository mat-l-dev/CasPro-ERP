...
|---|---|---|
| D01 AI/Architecture | Activación de Accounting IA/shadow confirmados en diseño M07–M08; proveedor/recursos/otros pilotos opcionales | [Contrato](../accounting/templates-automation-shadow.md) requerido en diseño; antes de activar: propósito/mandato, minimización/DPA, versiones, corpus/umbral B16, coste y aislamiento B02/B13/B15. Otros pilotos mantienen trigger de beneficio esperado/autorización. Flujo manual/determinístico completo permanece válido; D01 no vuelve opcional construir el diseño confirmado |
