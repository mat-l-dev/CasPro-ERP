...
| Document delivery | Documents | deliverable+approval→intento/resultado; envío externo conocido→historia sustentada | Resend opcional u otro adaptador autorizado; registro externo sin proveedor | CPE delivery; HIGH | M04 / CPE+C40, delta propuesto / nuevo transporte |
