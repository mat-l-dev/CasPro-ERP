...
Para aprobar NP-01–NP-18: hechos/elecciones acreditados; interpretación profesional de pendientes; casos sintéticos balanceados y reproducibles; trazabilidad norma→política→regla→asiento→estado/nota. El expediente puede quedar completo técnicamente y conservar una elección empresarial pendiente, pero **no se declara FROZEN ni operativo** cuando esa elección altera reconocimiento, datos necesarios o salida obligatoria.
