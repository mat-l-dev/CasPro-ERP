...
El [catálogo NPIF](npif-policy-catalog.md), [M07](../specs/accounting-deep.md) y [M08](../specs/reporting-goldens.md) especifican apertura, mediciones, flujos, moneda, correcciones y paquete como candidato. Pendiente: confirmar elegibilidad y hechos del primer año; validar profesionalmente esas políticas y notas, incluidos supuestos supletorios; revisar el candidato por separado. La existencia de una spec no reemplaza esa aceptación ni evidencia ejecución del período sintético.
