...
[Documentos/sitio/reclamos](../specs/flows/records-signatures-site-packs.md) muestra original/derivado/firma/custodia, vencimientos de visita y plazo de respuesta sin equipararlos con autorización/cierre. Workspace fiscal separa obligación activa de readiness futura. Tablas de comparación técnica/monetaria explican diferencias, UNKNOWN y permisos; preparación no activa envío ni acción económica con Enter accidental. B09/B10 permanecen sin ejecutar.
