...
## Preparación de contexto por finalidad

privacy.context.prepare se concede explícitamente a un humano mediante Access; no se deriva del puesto, de ser custodio ni de otro rol. Para una finalidad P y su contexto, el guard exige conjuntamente: (1) concesión vigente de privacy.context.prepare con referencia explícita a entidad/P; (2) concesión vigente de la capability literal Prepare que la [matriz tipada de política](configuration-governance.md#capacidades-tipadas-de-política) asigna al owner/familia de P, sobre el recurso de política correspondiente; (3) configuration.prepare por mandato administrativo o ConfigDelegation vigente para esa misma familia/alcance, conforme CG1. Las tres coberturas deben contener la misma entidad, finalidad y recursos del contexto, además de las lecturas/restricciones/SoD pertinentes. Ninguna sustituye a las otras.

El owner/familia de P referencia un ConfigurationDescriptor estático registrado, no texto elegido por el solicitante; su contrato determina una única capability Prepare exacta de la matriz, sin derivarla concatenando nombres ni aceptar aliases. Por ejemplo, finalidad contable: privacy.context.prepare AND accounting.policy.prepare AND autoridad configuration.prepare de esa familia. documents.policy.prepare no satisface la autoridad contable. R-RECORDS delegado debe reunir la misma conjunción mediante concesiones explícitas válidas, sin excepción por custodia ni herencia automática.

Se comprueban el vínculo P→descriptor, contexto→P, revisión esperada, vigencia y scopes actuales bajo las guardas A5/M25 existentes. Un alta usa ID de finalidad preasignado en la intención y explícitamente cubierto por el mandato, sin que el borrador se conceda autoridad. Ausencia/ambigüedad de descriptor o permiso, otra entidad/finalidad/familia, cambio de revisión o revocación deniega; el contexto no puede cambiar de dueño para reutilizar grants. Registrar otra finalidad exige su propio mandato, nunca un wildcard de privacidad. Preparar no aprueba fundamento jurídico, no activa tratamiento ni modifica los IDs del catálogo.

<a id="marketing-content-capabilities"></a>
## Marketing Content — IDs del amendment

**17 IDs nuevos**, sujetos a revisión independiente; no aliases ni concesiones reales. Elegibilidad exacta de R-MARKETING/R-MARKETING-APPROVE en [roles](roles-delegation.md#marketing-content-roles), sin incluirlos en OPERATIVOS ni recibir otros permisos de ese conjunto. Cada comando exige además marketing.view sobre su objeto y lecturas/guardas de participantes; política exige autoridad administrativa previa. Nadie recibe publicación automática ni un nuevo principal técnico por esta tabla.

| ID exacto | Elegibilidad humana | Scope mínimo | Consumidor y conjunción |
|---|---|---|---|
| marketing.view | R-MARKETING, R-MARKETING-APPROVE; R-AUDIT o R-RECORDS por mandato | Entidad/objetos y campos autorizados | MC9: lectura de metadata; no preview/descarga implícitos; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.asset.prepare | R-MARKETING | Entidad/activo/revisión/carpeta origen y destino | MC2: preparar/revisar/asociar y solicitar IN_REVIEW; ingest AND documents.ingest, render AND documents.render; mover AND marketing.folder.manage; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.asset.approve | R-MARKETING-APPROVE | Entidad/activo/revisión/representación/finalidad/canal | MC3: aprobar/rechazar uso y decidir derechos; digest/evidencia/SoD, no autoridad legal implícita; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.asset.retire | R-MARKETING-APPROVE | Entidad/activo/revisión y usos afectados | MC3: retirar uso efectivo; no borrar publicación ni levantar DataRestriction; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.asset.archive | R-MARKETING | Entidad/activo | MC3: archivar/desarchivar; no purge ni reaprobar; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.folder.manage | R-MARKETING | Entidad/carpetas origen/destino | MC1: crear/renombrar/mover/archivar/restaurar árbol; no cambiar grants; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.campaign.manage | R-MARKETING | Entidad/campaña/revisión y referencias | MC4: organizar/transicionar campaña; no aprobar activos ni ejecutar red; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.brand.prepare | R-MARKETING | Entidad/marca/kit/revisión | MC5: preparar y enviar a revisión; no render engine; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.brand.approve | R-MARKETING-APPROVE | Entidad/marca/kit/revisión/usos | MC5: aprobar/rechazar/retirar kit, activos/evidencia y SoD; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.copy.prepare | R-MARKETING | Entidad/texto/revisión/canales | MC6: preparar/enviar a revisión; texto IA sigue propuesta; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.copy.approve | R-MARKETING-APPROVE | Entidad/texto/revisión/finalidad/canal | MC6: aprobar/rechazar/retirar copy; SoD y derechos; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.publication.prepare | R-MARKETING | Entidad/plan/revisión/canal/destino/ventana | MC7: preparar/enviar a revisión/cancelar/sustituir plan; no envío; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.publication.approve | R-MARKETING-APPROVE | Entidad/plan/revisión/contenido/destino/ventana | MC7: aprobar/rechazar plan exacto y SoD; no ejecución ni descarga; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.publication.record_external | R-MARKETING | Entidad/observación/canal/cuenta/recursos de evidencia | MC8: registrar/corregir hecho MANUAL_EXTERNAL con procedencia; no autoautorizar ni inventar callback; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.download_original | R-MARKETING, R-MARKETING-APPROVE; R-RECORDS por mandato expreso | Entidad/activo/revisión/original/finalidad | MC9: AND marketing.view, documents.view y documents.download actuales; no por preview; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.policy.prepare | R-MARKETING | Entidad/familia MARKETING_CONTENT/finalidad y recursos | CG1–5: AND configuration.prepare con autoridad administrativa misma familia; contexto personal además privacy.context.prepare; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
| marketing.policy.approve | R-MARKETING-APPROVE | Entidad/familia MARKETING_CONTENT/revisión/manifest | CG1–5: AND configuration.approve; activación además configuration.activate, evidencia/SoD; no autoridad jurídica; [contrato](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |

Los IDs Documents/support necesarios se amplían expresamente en sus filas originales: ningún otro ID hereda elegibilidad. Para original Marketing, todas las rutas de bytes comprueban marketing.download_original y audiencia Marketing además de permisos Documents; coordinación entrega valores verificados, sin llamada Documents→Marketing. Lectura R-RECORDS del activo solo mediante marketing.view por mandato documental; custodia no recibe aprobación. Cualquier grant futuro enumera recurso/finalidad, no se crea ahora.
...
| documents.download | R-RECORDS; OPERATIVOS, R-AUDIT, R-MARKETING, R-MARKETING-APPROVE por mandato documental | Entidad/clase/objeto/revisión/audiencia | Descargar versión; AND documents.view, audiencia y restricción. [Consumidor](../specs/cross-cutting/case-flow-preview.md) |
...
| documents.ingest | OPERATIVOS; R-MARKETING solo MC2 | Entidad/clase/objeto/revisión/audiencia | Contrato local del dueño para ingest. [Consumidor](../specs/flows/records-signatures-site-packs.md) |
...
| documents.preview | OPERATIVOS, R-AUDIT; R-MARKETING, R-MARKETING-APPROVE solo MC9 | Entidad/clase/objeto/revisión/audiencia | Render de vista; AND documents.view, sin original por tener preview. [Consumidor](../specs/cross-cutting/case-flow-preview.md) |
...
| documents.render | R-RECORDS; R-MARKETING solo MC2 | Entidad/clase/objeto/revisión/audiencia | Contrato local del dueño para render. [Consumidor](../specs/acceptance/reporting-goldens.md) |
...
| documents.view | OPERATIVOS; R-AUDIT por mandato; R-MARKETING, R-MARKETING-APPROVE solo evidencia Marketing | Entidad/clase/objeto/revisión/audiencia | Contrato local del dueño para view. [Consumidor](../specs/cross-cutting/case-flow-preview.md) |
...
| privacy.context.prepare | Humano con concesión explícita y conjunción de permisos de la sección Preparación de contexto por finalidad; sin privilegio implícito de R-RECORDS | Entidad/P explícita + owner/familia/recurso de política + contexto/revisión coincidentes | Preparar ProcessingContext: AND capability Prepare exacta del descriptor/matriz AND configuration.prepare administrativamente autorizada; no aprobar base jurídica ni habilitar tratamiento. [Consumidor](../security/personal-data-lifecycle.md) |
...
| privacy.execute | R-ACCESS para restricciones; R-RECORDS para artefactos; R-MASTER para atributos; R-MARKETING solo MC10, por plan expreso | Entidad/finalidad/caso/sujeto/objeto/categoría/plan | Aplicar paso autorizado; AND capability exacta del dueño/tipo de objeto y plan aprobado/revisión vigente; no borrado económico ni ejecución general. [Contrato transversal](../security/personal-data-lifecycle.md); [MC10 Marketing](../specs/flows/marketing-content-media-library.md#comandos-atomicidad-y-correcciones) |
...
| support.reference.read | OPERATIVOS; R-MARKETING, R-MARKETING-APPROVE solo referencias del caso Marketing | Objeto de soporte del caso autorizado | Lectura mínima ID/nombre/UOM/estado del objeto necesario; no expediente completo. [Consumidor](roles-delegation.md) |
