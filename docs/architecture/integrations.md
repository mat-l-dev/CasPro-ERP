...
La concreción del primer circuito vive en [integraciones SP2](../specs/integrations.md) y [CPE/Documents](../specs/cpe-document-delivery.md): estados, comandos, permisos y escenarios se mantienen allí, sin promover a validados los mecanismos del ADR.
