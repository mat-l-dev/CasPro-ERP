...
Propietario: Tax. Estado: RESEARCHED / NEEDS POLICY SPEC AND PROFESSIONAL VALIDATION. Tax no es Accounting ni un generador de hechos operativos.
...
Fuentes canónicas: [registro normativo](../research/normative-register.md). Cada policy spec citará texto legal consolidado y, cuando proceda, RTF/Informe con hechos, alcance, carácter vinculante y límites.
