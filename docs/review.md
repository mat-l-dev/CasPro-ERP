...
PR #8 aceptado y abierto: únicamente sincronización de estado; merge pendiente de autorización explícita del propietario. La aceptación no autoriza merge, regeneración/ejecución de WOs ni implementación.
