...
El diseño profesional de crédito/COD está aceptado; primera venta y B2B inicial siguen prepago íntegro. El mandato de gobierno siguiente confirma construcción obligatoria de crédito y mantiene COD separado bajo D03. Se elige promedio uniforme por decisión delegada, conservando FIFO como salida física y gates de política fiscal real. La necesidad confirmada no se deja sin contrato para implementación; la entrega sigue incremental M02–M09. El amendment profesional está aceptado por re-revisión independiente según review; las aceptaciones anteriores permanecen y no habilitan código/WOs.

**Enmienda de gobierno propuesta:** el propietario confirma crédito B2B como **REQUIRED TO IMPLEMENT**, con activación controlada por configuración e inicialmente DISABLED. El [programa](../roadmap/program.md) fija incremento obligatorio tras B2B+Treasury; D03 conserva activación y COD su trigger separado. [Roles profesionales](../architecture/roles-delegation.md), [Centro de Configuración](../architecture/configuration-governance.md) y [TILMUX Policy Register](company-policy-register.md) preparan operación con personal futuro y excepciones honestas de arranque. No habilita código ni aprueba políticas reales; revisión independiente pendiente según review.
