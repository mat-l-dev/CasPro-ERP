...
Delta propuesto de gobierno: [roles/delegación/último-admin](../../architecture/roles-delegation.md) y [configuración CG1–5](../../architecture/configuration-governance.md) son parte de M01, no maker/checker universal diferido a M10. Entrega estructuras/plantillas versionadas, scopes por capability, revocación y recuperación; solo concede funciones ya entregadas y expresamente autorizadas. Preview incluye expansión/SoD/impacto y prueba negativa de admin sin autoridad económica. Los [valores por hito](../../product/company-policy-register.md#readiness-de-políticas) evitan exigir descuentos/crédito/manual real completo para M01. POL-01–04/22, identidad/custodia y C10/C13 preceden su uso real. No cuentas ni políticas activadas en esta misión.
