...
Estado: **SPECIFIED — candidato; perfil real y políticas PENDING PROFESSIONAL VALIDATION**. Owner Tax. Entradas: [investigación actual](../research/tax-current-review.md), [mutuo](../research/mutuo-tax-corporate.md), [registro normativo](../research/normative-register.md), [contrato profundo](economic-facts.md). M09 no posterga obligaciones legales activadas en M03–M06. Antes de UI tributaria, expediente/manual profesional y evidencia conservada son gate operativo.
...
| X05 registrar presentación/constancia / tax.record_filing / D | Evidencia externa, período/tipo/identidad y snapshot I→O→Q→D | Hecho de presentación aceptada/rechazada según respuesta verificable; no “enviado=aceptado”. Uso inicial manual; API futura exige WO/contrato, credenciales fuera de repo |
