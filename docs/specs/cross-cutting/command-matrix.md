...
Delta de gobierno propuesto: [RA1–4](../../architecture/roles-delegation.md#principales-técnicos-y-comandos) y [CG1–5](../../architecture/configuration-governance.md#manifiesto-de-impacto-y-concurrencia) heredan CM0. Autorización combina grants por la misma capability, nunca scopes cruzados entre acciones. Cambios críticos y efectos privilegiados revalidan epoch/mandato bajo A5; políticas y consumidores coordinan por raíz M25 antes de H27/S/O30. Payload guarda policy revision/manifest; preview obsoleto rechaza. No adelanta K10 después de M25 ni crea mutex global. El command owner mantiene guardas de negocio/SoD además del permiso administrativo.
