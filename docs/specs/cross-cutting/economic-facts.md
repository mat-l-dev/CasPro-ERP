...
Enmienda de gobierno: cambio de [política tipada](../../architecture/configuration-governance.md) registra revisión/manifest/fecha/actor, sin producir ingreso/gasto/dinero por activarla. Consumidor guarda revisión aplicada y toma raíz de política M25 antes de H27/S/O30; activador serializa el cambio y revalida abiertos, sin reescribir snapshots. A5 precede revalidación privilegiada. La configuración contable vigente no reinterpreta un posting histórico: corrección/transición conserva envelope y linaje propios.
