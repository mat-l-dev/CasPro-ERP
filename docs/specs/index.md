...
[WOs actuales M01–M09](../work-orders/index.md): conjunto regenerado candidato y [dependencias de entrega](../work-orders/roadmap.md), pendiente de revisión independiente. Las fichas históricas/readiness de esta página se conservan como procedencia; ninguna WO está autorizada para ejecución y [review](../review.md) gobierna la fase.
