...
[WOs actuales M01–M09](../work-orders/index.md): conjunto corregido aceptado en PR #10 para el alcance anterior a Marketing y [dependencias de entrega](../work-orders/roadmap.md). Las fichas históricas/readiness de esta página se conservan como procedencia; ninguna WO está autorizada para ejecución y [review](../review.md) gobierna la fase.

Nuevo [Marketing Content / Media Library](flows/marketing-content-media-library.md): **SPECIFIED — PENDING INDEPENDENT REVIEW**, incremento paralelo M03+ según [programa](../roadmap/program.md#marketing-content-increment); no modifica las filas históricas M01–M09. Seis capacidades confirmadas nuevas con WO coverage pendiente del delta posterior autorizado. [Gates existentes](../roadmap/decisions-gaps.md#marketing-content-gates) y [40 casos/impacto](../evidence/marketing-content-amendment.md); sin generar WOs ni implementar.

Delta de PR #7 con PASS independiente preservado para5886b821 conforme review: [Case Flow/preview](cross-cutting/case-flow-preview.md), [familias y modos de automatización](../architecture/automation.md), [Accounting templates/IA/shadow](../accounting/templates-automation-shadow.md), [informe A–AS](../evidence/intelligent-automation-visual-flow.md). El [delta final proveedor/coste y filing mirror](../evidence/final-ai-tax-filing-delta.md) está aceptado documentalmente según review; [contrato Tax](flows/external-tax-filing-mirror.md) y [AI](../architecture/ai-assistance.md#presupuesto-y-programación-del-proveedor-inicial) lo especifican. D01/B16 controlan activación Accounting IA M07–M08; las filas históricas de readiness siguientes no describen ese nuevo delta.
...
El freeze, arquitectura de información y sistema de agentes/skills están aceptados según [review](../review.md). PR #6 está integrado; el delta final de PR #7 está aceptado documentalmente según review, preservando los PASS anteriores. Merge, regeneración de WOs e implementación necesitan sus posteriores autorizaciones conforme review. Las [seis WOs SP2](../history/work-orders-sp2.md) son insumos históricos NEEDS REGENERATION AFTER FREEZE: incorporar hechos tempranos, pool/revisiones, CM0 extendido, CPE, UX y gates locales antes de encargarlas; esta misión no las regenera.
