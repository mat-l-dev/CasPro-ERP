...
Delta posterior al PASS inicial de PR #7: [Case Flow/preview](cross-cutting/case-flow-preview.md), [familias y modos de automatización](../architecture/automation.md), [Accounting templates/IA/shadow](../accounting/templates-automation-shadow.md), [informe A–AS](../evidence/intelligent-automation-visual-flow.md). Nuevo candidato pendiente de re-revisión según review. D01/B16 controlan activación Accounting IA M07–M08; las filas históricas de readiness siguientes no describen ese nuevo delta.
