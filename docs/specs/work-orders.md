...
Estas seis WOs quedan como insumos preparados de M01–M04 y deben reordenarse o dividirse conforme a las [deep specs M01–M09](deep-spec-index.md) antes del GLOBAL DOCUMENTATION FREEZE. **WO-SP2-01** continúa siendo la primera dependencia técnica candidata de entrega, después de freeze global y autorización. Las correcciones Astra de oportunidad/cardinalidad CPE forman parte de sus entradas. Ninguna WO se ejecuta por estar preparada; cada una requiere autorización, candidato/base Git y evidencia de dependencias, sin copiar una etiqueta PASS fuera de su contrato de equivalencia.
