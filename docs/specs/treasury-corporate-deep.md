...
| CO03 preparar desembolso/reembolso / treasury.prepare_financing / D | Instrumento vigente, límite dispuesto/reembolsado, moneda, acreedor, banco I→M→O→T→F→R→D | Objetivo Treasury/plan de pago; no confirma dinero. Cada drawdown tiene identidad y vincula evidencia de entrega; reembolso reduce principal/interés solo con asignación explícita |
