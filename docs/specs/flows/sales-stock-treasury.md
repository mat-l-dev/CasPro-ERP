...
Este circuito conserva entrada Jumpseller/primera venta B2C. El [incremento B2B aceptado](b2b-commercial-dossier.md) reutiliza pedido, reservas, objetivos, cobros y parcialidades mediante entrada comercial local con OC/cotización opcionales; no crea una conexión ficticia ni habilita crédito. Es delta aceptado del amendment, sin alterar la cobertura íntegra exigida aquí.
