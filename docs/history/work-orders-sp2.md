# SP2 — Work Orders históricas pendientes de regeneración

HISTORICAL EVIDENCE. Período: SP2–freeze, 2026-09-10–11. Estas fichas registran la primera tranche diseñada; el [estado vigente](../review.md), las [specs](../specs/index.md) y el [contrato de Work Order](../../.ai/work-order.md) gobiernan cualquier encargo futuro.
...
Los [perfiles de evidencia y gates habilitantes](../specs/acceptance/validation-profiles.md) se conservan íntegros en la sección de aceptación. Las fichas siguientes son antecedentes; esa extracción no las regenera ni autoriza.
