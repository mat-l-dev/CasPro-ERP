...
| IMPLEMENTER | [Estado/autorización](review.md) → [WOs actuales candidatas](work-orders/index.md) y su [DAG](work-orders/roadmap.md) → [hito/spec local](specs/index.md) → contrato del dueño y dependencias citadas → [gates](roadmap/decisions-gaps.md) / [calidad](quality/strategy.md) / [contrato de WO](../.ai/work-order.md). Regeneradas, pendientes de revisión independiente; ninguna autorizada para ejecución. [M03 tiene una ruta concreta](specs/index.md#navegar-por-función) |
