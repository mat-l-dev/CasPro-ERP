...
Privacidad técnica, restricciones, configuración/acceso o restore → platform; aplicabilidad jurídica de privacidad/IA → compliance, con normative-research solo si hay pregunta de fuente/vigencia; reconciliar ownership → architecture. Templates/automatización/Shadow Accounting → accounting; transporte AIService → external-effects; aislamiento → platform. Case Flow/preview → ui; filing mirror → compliance. Documents sigue al resultado: custodia/seguridad en platform, representación en ui, entrega en external-effects y frontera de propiedad en architecture. Ninguna de estas rutas crea dueño ni skill nueva. Las [rutas transversales](README.md#rutas-transversales-por-trigger) activan registro exacto y privacidad solo cuando corresponda.
...
| [caspro-accounting](../.agents/skills/caspro-accounting/SKILL.md): ledger y reporting | Posting, cierre, EEFF, templates/AI/shadow; no inventar mapping/política | [Accounting](../docs/accounting/architecture.md), M07/M08 y contrato del modo | Alto; Accounting independiente + validación profesional local | C/G/T |
| [caspro-compliance](../.agents/skills/caspro-compliance/SKILL.md): Tax y actos/aplicabilidad legal | Tax/filing mirror, BF, mutuo, privacidad/IA legal; no aprobación profesional por IA | [Tax](../docs/tax/architecture.md), [Corporate](../docs/corporate/architecture.md) o contrato de privacidad/IA según modo | Alto; profesional competente + reviewer independiente | C/G/T |
...
| [caspro-platform](../.agents/skills/caspro-platform/SKILL.md): plataforma por modo | M01, Party/M02, acceso/configuración, privacidad técnica, restore; no cargar todos los modos | Contrato del modo; [M01–M02](../docs/specs/milestones/runtime-masters.md) cuando aplique | Acceso/operación alto; seguridad/operaciones independiente | C/G/T |
...
Los tres leen el mismo Markdown; solo C/G tienen discovery documentado en esta ubicación. No hay symlinks, copias, wrappers por skill, hooks ni configuración que eleve permisos. Si falta discovery puede usarse lectura explícita permitida; nunca eludir consentimiento denegado. [Research oficial y límites](../docs/research/agent-tooling-currentness.md) documentan las diferencias; esta tabla no acredita ejecución real en cada harness.
