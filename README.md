...
- SUPERPROMPT 2 fue autorizado posteriormente y se concreta en la [especificación del primer circuito B2C](docs/specs/first-operational-circuit.md). Sus seis Work Orders están preparadas; implementación y ejecuciones requieren un nuevo encargo. Véase el [criterio de avance](docs/review.md).
